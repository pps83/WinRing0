...
BOOL InstallDriver(SC_HANDLE hSCManager, LPCTSTR DriverId, LPCTSTR DriverPath)
{
    ...
    hService = CreateService(hSCManager, DriverId, DriverId, SERVICE_ALL_ACCESS, SERVICE_KERNEL_DRIVER,
...
BOOL SystemInstallDriver(SC_HANDLE hSCManager, LPCTSTR DriverId, LPCTSTR DriverPath)
{
    ...
    if (hService != NULL)
    {
        rCode = ChangeServiceConfig(hService, SERVICE_KERNEL_DRIVER, SERVICE_AUTO_START, SERVICE_ERROR_NORMAL,
